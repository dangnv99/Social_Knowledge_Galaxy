...
export default function Dashboard() {
      ...
      case "popular":
        return filtered.sort(
          (a, b) =>
            ...
            b.views -
            (a.rating * a.totalRatings + a.views)
        );
      case "my":
  ...
  return (
    <div className="p-6 space-y-8">
        ...
        {searchFilters.query && (
          <div className="mt-4 flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-700">
              Tìm thấy {filteredDocuments.length} kết quả cho "
              {searchFilters.query}"
            </span>
          </div>
        )}
      ...
      <div className="w-full flex items-center justify-between bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-600">
              ...
              trong {filteredDocuments.length} tài liệu
            </div>
      ...
      <div className="w-full space-y-6">
        ...
        {/* Popular Documents */}
        {/* Activities */}
        {/* nếu muốn có thể bật lại các section này */}
      </div>
    </div>
  );
}
