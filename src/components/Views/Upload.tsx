...
export default function Upload() {
  ...
  // ✅ Gọi API thật để lấy text từ file Word/PDF
  const generateSummaryFromAPI = async (file: File) => {
    ...
    try {
      ...
      const res = await fetch(
        "https://ced24b621922.ngrok-free.app/reader/word-text",
        {
          method: "POST",
          headers: {
            Accept: "text/plain",
      ...
      // Gợi ý tags đơn giản
      setSuggestedTags(["AI", "Generated", "Document"]);
    } catch (err) {
      console.error("Lỗi khi gọi AI:", err);
      alert("Không thể tạo tóm tắt từ API. Vui lòng thử lại.");
    } finally {
  ...
  const handleNext = async () => {
    if (
      ...
      if (selectedFile) {
        await generateSummaryFromAPI(selectedFile);
      }
      setCurrentStep(2);
          ...
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Cung cấp thông tin tài liệu của bạn
              </p>
            </div>
            ...
            <div>
              <label className="block text-gray-900 font-medium mb-2">
                Nội dung (Tùy chọn nếu đã tải file)
              </label>
              <textarea
            ...
            <div className="flex justify-end">
              <button
                onClick={handleNext}
                disabled={
                  !formData.title || (!formData.content && !selectedFile)
                }
        ...
        {currentStep === 2 && (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Phân tích nội dung và gắn thẻ bằng AI
              </p>
            </div>
        ...
        {currentStep === 3 && (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Chọn ai có thể truy cập tài liệu của bạn
              </p>
            </div>
              ...
              {(["private", "group", "public"] as const).map((visibility) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-4">
                      <div
                        className={`w-12 h-12 rounded-full bg-gradient-to-r ${config.color} flex items-center justify-center`}
                      >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-gray-900">
                    {formData.tags || "Không có"}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Truy cập:</span>
                  <span className="text-gray-900">
                    {getVisibilityConfig(formData.visibility).label}
                  </span>
                </div>
              </div>
            </div>
